...
export default class NumericInput extends Component {
    ...
    render() {
        ...
        if (this.props.type === 'up-down')
            return (
                <View style={inputContainerStyle}>
                    ...
                    <View style={upDownStyle}>
                        <Button enabled={this.props.enabled} onPress={this.inc} style={{ flex: 1, width: '100%', alignItems: 'center' }}>
                        ...
                        <Button enabled={this.props.enabled} onPress={this.dec} style={{ flex: 1, width: '100%', alignItems: 'center' }}>
            ...
            <View style={inputContainerStyle}>
                <Button enabled={this.props.enabled} onPress={this.dec} style={leftButtonStyle}>
                ...
                <View style={[inputWraperStyle]}>
                    <TextInput {...this.props.extraTextInputProps} editable={this.props.enabled} returnKeyType='done' underlineColorAndroid='rgba(0,0,0,0)' keyboardType='numeric' value={this.state.stringValue} onChangeText={this.onChange} style={inputStyle} ref={ref => this.ref = ref} onBlur={this.onBlur} onFocus={this.onFocus} />
                </View>
                <Button enabled={this.props.enabled} onPress={this.inc} style={rightButtonStyle}>
